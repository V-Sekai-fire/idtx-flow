...
PROTOBUF_CONSTEXPR Ack::Ack(
    ...
    /*decltype(_impl_.ref_id_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
static ::_pb::Metadata file_level_metadata_session_2eproto[2];
...
const uint32_t TableStruct_session_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::idtxcore::Ack, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::idtxcore::Ack, _impl_.ref_id_),
  PROTOBUF_FIELD_OFFSET(::idtxcore::Ack, _impl_.ok_),
  PROTOBUF_FIELD_OFFSET(::idtxcore::Ack, _impl_.error_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::idtxcore::Error, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::idtxcore::Error, _impl_.code_),
  PROTOBUF_FIELD_OFFSET(::idtxcore::Error, _impl_.message_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::idtxcore::Ack)},
  { 9, -1, -1, sizeof(::idtxcore::Error)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::idtxcore::_Ack_default_instance_._instance,
  &::idtxcore::_Error_default_instance_._instance,
};

const char descriptor_table_protodef_session_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rsession.proto\022\010idtxcore\"0\n\003Ack\022\016\n\006ref_"
...
const ::_pbi::DescriptorTable descriptor_table_session_2eproto = {
    false, false, 123, descriptor_table_protodef_session_2eproto,
    "session.proto",
    &descriptor_table_session_2eproto_once, nullptr, 0, 2,
...
Ack::Ack(const Ack& from)
  ...
  // @@protoc_insertion_point(copy_constructor:idtxcore.Ack)
}
...
Ack::~Ack() {
  // @@protoc_insertion_point(destructor:idtxcore.Ack)
...
void Ack::Clear() {
// @@protoc_insertion_point(message_clear_start:idtxcore.Ack)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "idtxcore.Ack.ref_id"));
        } else
          goto handle_unusual;
        continue;
      // bool ok = 2;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "idtxcore.Ack.error"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* Ack::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:idtxcore.Ack)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  // string ref_id = 1;
  if (!this->_internal_ref_id().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_ref_id().data(), static_cast<int>(this->_internal_ref_id().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "idtxcore.Ack.ref_id");
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_ref_id(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:idtxcore.Ack)
  return target;
}

size_t Ack::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:idtxcore.Ack)
  size_t total_size = 0;
...
void Ack::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:idtxcore.Ack)
...
// @@protoc_insertion_point(class_specific_copy_from_start:idtxcore.Ack)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void Ack::InternalSwap(Ack* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.ref_id_, lhs_arena,
      &other->_impl_.ref_id_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
...
Error::Error(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:idtxcore.Error)
}
Error::Error(const Error& from)
  ...
  // @@protoc_insertion_point(copy_constructor:idtxcore.Error)
}
...
Error::~Error() {
  // @@protoc_insertion_point(destructor:idtxcore.Error)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
void Error::Clear() {
// @@protoc_insertion_point(message_clear_start:idtxcore.Error)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "idtxcore.Error.code"));
        } else
          goto handle_unusual;
        continue;
      // string message = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "idtxcore.Error.message"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* Error::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:idtxcore.Error)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:idtxcore.Error)
  return target;
}

size_t Error::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:idtxcore.Error)
  size_t total_size = 0;
...
void Error::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:idtxcore.Error)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:idtxcore.Error)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::idtxcore::Ack*
Arena::CreateMaybeMessage< ::idtxcore::Ack >(Arena* arena) {
  return Arena::CreateMessageInternal< ::idtxcore::Ack >(arena);
}
template<> PROTOBUF_NOINLINE ::idtxcore::Error*
Arena::CreateMaybeMessage< ::idtxcore::Error >(Arena* arena) {
  return Arena::CreateMessageInternal< ::idtxcore::Error >(arena);
}
