...
class IDTXFLOW_GODOT_API IUsdNode3D
{
  public:
     ...
     */
    virtual IExecBridgeHandler* get_exec_bridge_handler() noexcept
    {
        return nullptr;
    }
     ...
     * @return prim_path
     */
    virtual godot::String get_stage_path() const
    {
        return stage_path_;
    }
     ...
     * @param stage_path
     */
    virtual void set_stage_path(const godot::String& stage_path)
    {
     ...
     * @return
     */
    virtual godot::String get_prim_name() const
    {
        return prim_name_;
    }
     ...
     * @param prim_name
     */
    virtual void set_prim_name(const godot::String& prim_name)
    {
     ...
     * @return prim_path
     */
    virtual godot::String get_prim_path() const
    {
        return prim_path_;
    }
     ...
     * @param prim_path
     */
    virtual void set_prim_path(const godot::String& prim_path)
    {
     ...
     * @param prim_type
     */
    virtual void set_prim_type(const godot::String& prim_type)
    {
     ...
     * @param is_converting
     */
    virtual void set_variantset_selected_variant(const godot::String& variant_set, const godot::String& value,
  ...
  protected:
     ...
     * @return
     */
    virtual godot::Dictionary get_variantsets_selected_variants() const
    {
        return variant_sets_variant_;
    }
     ...
     * @param sets_values
     */
    virtual void set_variantsets_selected_variants(const godot::Dictionary& sets_values)
    {
        variant_sets_variant_ = sets_values;
    }
...
#define IUSDNODE_IMPLEMENT_GETTER_SETTER(                                                                              \
    m_has_exec_bridge_handler) /*** Implement "redirect" to IUsdNode3D setter/getter to be used in Binding *****/      \
  public:                                                                                                              \
    IDTXFLOW_IUSDNODE_EXEC_BRIDGE_HANDLER(m_has_exec_bridge_handler)                                                   \
    godot::String get_stage_path() const override                                                                      \
    {                                                                                                                  \
        return IUsdNode3D::get_stage_path();                                                                           \
    }                                                                                                                  \
    void set_stage_path(const godot::String& stage_path) override                                                      \
    {                                                                                                                  \
        IUsdNode3D::set_stage_path(stage_path);                                                                        \
    }                                                                                                                  \
    godot::String get_prim_path() const override                                                                       \
    {                                                                                                                  \
        return IUsdNode3D::get_prim_path();                                                                            \
    }                                                                                                                  \
    void set_prim_path(const godot::String& prim_path) override                                                        \
    {                                                                                                                  \
        IUsdNode3D::set_prim_path(prim_path);                                                                          \
    }                                                                                                                  \
    godot::String get_prim_name() const override                                                                       \
    {                                                                                                                  \
        return IUsdNode3D::get_prim_name();                                                                            \
    }                                                                                                                  \
    void set_prim_name(const godot::String& prim_name) override                                                        \
    {                                                                                                                  \
        IUsdNode3D::set_prim_name(prim_name);                                                                          \
    }                                                                                                                  \
    godot::String get_prim_type() const override                                                                       \
    {                                                                                                                  \
        return IUsdNode3D::get_prim_type();                                                                            \
    }                                                                                                                  \
    void set_prim_type(const godot::String& prim_type) override                                                        \
    {                                                                                                                  \
        IUsdNode3D::set_prim_type(prim_type);                                                                          \
    }                                                                                                                  \
    godot::Dictionary get_variantsets() const override                                                                 \
    {                                                                                                                  \
        return IUsdNode3D::get_variantsets();                                                                          \
    }                                                                                                                  \
    void set_variantsets(const godot::Dictionary& variant_sets) override                                               \
    {                                                                                                                  \
        IUsdNode3D::set_variantsets(variant_sets);                                                                     \
    }                                                                                                                  \
    godot::PackedStringArray get_variantset_variants(const godot::String& name) const override                         \
    {                                                                                                                  \
        return IUsdNode3D::get_variantset_variants(name);                                                              \
    }                                                                                                                  \
    void set_variantset_variants(const godot::String& name, const godot::PackedStringArray& values) override           \
    {                                                                                                                  \
        IUsdNode3D::set_variantset_variants(name, values);                                                             \
    }                                                                                                                  \
                                                                                                                       \
  protected:                                                                                                           \
    godot::Dictionary get_variantsets_selected_variants() const override                                               \
    {                                                                                                                  \
        return IUsdNode3D::get_variantsets_selected_variants();                                                        \
    }                                                                                                                  \
    void set_variantsets_selected_variants(const godot::Dictionary& sets_values) override                              \
    {                                                                                                                  \
        IUsdNode3D::set_variantsets_selected_variants(sets_values);                                                    \
    }

#define IUSDNODE_IMPLEMENT_BINDINGS(                                                                                   \
    m_class) /*** Implement Binding-Code for the properties provided by the IUsdNode interface ***/                    \
    ...
    ADD_PROPERTY(godot::PropertyInfo(godot::Variant::STRING, "stage_path", godot::PROPERTY_HINT_NONE, "",              \
    ...
    ADD_PROPERTY(godot::PropertyInfo(godot::Variant::STRING, "prim_path", godot::PROPERTY_HINT_NONE, "",               \
                                     godot::PROPERTY_USAGE_STORAGE | godot::PROPERTY_USAGE_EDITOR |                    \
                                         godot::PROPERTY_USAGE_READ_ONLY),                                             \
    ...
    ADD_PROPERTY(godot::PropertyInfo(godot::Variant::STRING, "prim_name", godot::PROPERTY_HINT_NONE, "",               \
                                     godot::PROPERTY_USAGE_STORAGE | godot::PROPERTY_USAGE_EDITOR |                    \
                                         godot::PROPERTY_USAGE_READ_ONLY),                                             \
    ...
    ADD_PROPERTY(godot::PropertyInfo(godot::Variant::STRING, "prim_type", godot::PROPERTY_HINT_NONE, "",               \
                                     godot::PROPERTY_USAGE_STORAGE | godot::PROPERTY_USAGE_EDITOR |                    \
                                         godot::PROPERTY_USAGE_READ_ONLY),                                             \
    ...
    ADD_PROPERTY(godot::PropertyInfo(godot::Variant::DICTIONARY, "variant_sets", godot::PROPERTY_HINT_NONE, "",        \
                                     godot::PROPERTY_USAGE_STORAGE | godot::PROPERTY_USAGE_EDITOR |                    \
                                         godot::PROPERTY_USAGE_READ_ONLY),                                             \
                 "set_variant_sets", "get_variant_sets");                                                              \
                                                                                                                       \
    godot::ClassDB::bind_method(godot::D_METHOD("get_variant_sets_values"),                                            \
                                &m_class::get_variantsets_selected_variants);                                          \
    godot::ClassDB::bind_method(godot::D_METHOD("set_variant_sets_values", "variant_sets_values"),                     \
                                &m_class::set_variantsets_selected_variants);                                          \
    ADD_PROPERTY(godot::PropertyInfo(godot::Variant::DICTIONARY, "variant_sets_values", godot::PROPERTY_HINT_NONE, "", \
                                     godot::PROPERTY_USAGE_STORAGE | godot::PROPERTY_USAGE_EDITOR |                    \
                                         godot::PROPERTY_USAGE_READ_ONLY),                                             \
