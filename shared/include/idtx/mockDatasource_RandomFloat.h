...
//
#ifndef IDTX_GENERATED_MOCKDATASOURCE_RANDOMFLOAT_H
#define IDTX_GENERATED_MOCKDATASOURCE_RANDOMFLOAT_H

/// \file IDTX/mockDatasource_RandomFloat.h
...
/// \class IDTXMockDatasource_RandomFloat
///
/// This is an example mock data source that produces random float values.
...
class IDTXMockDatasource_RandomFloat : public IDTXDatasource
{
  public:
    ...
    /// Construct a IDTXMockDatasource_RandomFloat on UsdPrim \p prim .
    ...
    /// Destructor.
    IDTX_API
    virtual ~IDTXMockDatasource_RandomFloat();
    ...
    ///
    /// \code
    /// IDTXMockDatasource_RandomFloat(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    IDTX_API
