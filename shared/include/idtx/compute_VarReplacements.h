...
//
#ifndef IDTX_GENERATED_COMPUTE_VARREPLACEMENTS_H
#define IDTX_GENERATED_COMPUTE_VARREPLACEMENTS_H

/// \file IDTX/compute_VarReplacements.h
...
/// \class IDTXCompute_VarReplacements
///
///
...
public:
    ...
    /// Construct a IDTXCompute_VarReplacements on UsdPrim \p prim .
    ...
    /// Destructor.
    IDTX_API
    virtual ~IDTXCompute_VarReplacements();
    ...
    ///
    /// \code
    /// IDTXCompute_VarReplacements(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    IDTX_API
...
public:
    ...
    /// | ||
    /// | -- | -- |
    /// | Declaration | `string inputs:template = ""` |
    /// | C++ Type | std::string |
...
public:
    ...
    /// | ||
    /// | -- | -- |
    /// | Declaration | `string outputs:result = ""` |
    /// | C++ Type | std::string |
    /// | \ref Usd_Datatypes "Usd Type" | SdfValueTypeNames->String |
    IDTX_API
