...
class UsdStaticBodyNode3D : public godot::StaticBody3D, public IUsdNode3D
{
  ...
  public:
     ...
     */
    void set_transformData(const godot::Transform3D& trans)
    {
        transform_data_ = trans;
    }
    /**
     * Returns the current world transform data.
     * @return Reference to the stored Transform3D.
     */
    const godot::Transform3D& get_transformData() const
    {
     ...
     */
    void set_axis(const godot::Vector3& axis)
    {
        axis_ = axis;
    }
    /**
     ...
     */
    const int& get_collision_type() const
    {
        return collision_interaction_type;
    }
     ...
     */
    ShapeType get_collision_shape() const
    {
