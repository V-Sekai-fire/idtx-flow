...
void UsdStaticBodyNode3D::set_collision_shape_int(const int shape)
{
    ...
    {
    case 0:
        set_collision_shape("Cube");
        break;
    case 1:
        set_collision_shape("Sphere");
        break;
    case 2:
        set_collision_shape("Capsule");
        break;
    case 3:
        set_collision_shape("Cylinder");
        break;
    default:
        IDTX_LOG(IDTX_WARN, "Could not create collision shape since it looks to be unsupported!");
    }
}
...
{
    set_transform(trans);
    set_scale(godot::Vector3(1.0, 1.0, 1.0) // Reset scale!
    );
    ...
    if (axis_ != Vector3(0.0f, 0.0f, 0.0f))
    {
        ...
        Basis axis_correction = Basis(Vector3(1.0f, 0.0f, 0.0f), Math_PI / 2.0f);
...
void UsdStaticBodyNode3D::_bind_methods()
{
    ...
    ADD_PROPERTY(PropertyInfo(Variant::TRANSFORM3D, "transform_data_", PROPERTY_HINT_NONE, "",
    ...
    ADD_PROPERTY(PropertyInfo(Variant::INT, "collision_shape_", PROPERTY_HINT_ENUM, "Box,Sphere,Capsule,Cylinder"),
    ...
    ADD_PROPERTY(PropertyInfo(Variant::INT, "collision_interaction_type", PROPERTY_HINT_FLAGS, "Collide,Select"),
    ...
    ADD_PROPERTY(PropertyInfo(Variant::VECTOR3, "axis", PROPERTY_HINT_NONE, "",
    ...
    ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "height", PROPERTY_HINT_NONE, "",
                              PROPERTY_USAGE_READ_ONLY | PROPERTY_USAGE_DEFAULT),
    ...
    ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "radius", PROPERTY_HINT_NONE, "",
                              PROPERTY_USAGE_READ_ONLY | PROPERTY_USAGE_DEFAULT),
