...
class UsdMultiMeshInstanceNode3D : public godot::MultiMeshInstance3D, public IUsdNode3D
{
  ...
  public:
     ...
     * @param transform
     */
    void set_global_base_transform(const godot::Transform3D& transform)
    {
        global_base_transform_ = transform;
    }
     ...
     * @return
     */
    const godot::Transform3D& get_global_base_transform() const
    {
        return global_base_transform_;
    }
