...
class UsdSkeletonNode3D : public godot::Skeleton3D, public IUsdNode3D
{
  ...
  public:
     ...
     * @param map the map
     */
    void set_joint_to_bone_map(const godot::Dictionary& map)
    {
        joint_bone_map_ = map;
    }
     ...
     * @return
     */
    const godot::Dictionary& get_joint_to_bone_map() const
    {
        return joint_bone_map_;
    }
     ...
     */
    void set_bone_bind_transforms(const std::vector<godot::Transform3D>& transforms)
    {
        bone_bind_transforms_ = transforms;
    }
     ...
     * @return
     */
    const std::vector<godot::Transform3D>& get_bone_bind_transforms() const
    {
        return bone_bind_transforms_;
    }
